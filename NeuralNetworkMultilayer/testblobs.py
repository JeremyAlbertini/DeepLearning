...
X3, y3 = make_moons(n_samples=300, noise=0.1)
X2[:, 0] += 2
X3[:, 0] += 4
...
model = NNetwork(2, [128, 128, 128, 128, 128, 128, 128], 2)
...
anim.save(os.path.join(PATH_DIRECTORY, 'decision_boundary.gif'), writer='pillow')
plt.show()